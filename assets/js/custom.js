...
//  Parallax Background Image
    ...
    $(".progress2").each(function(){
        var $this = $(this);
        $this.find(".ts-progress-value2").text( $this.attr("data-progress-width") );
        $this.isInViewport(function(status) {
            if (status === "entered") {
                $this.find(".progress-bar2").width( $this.attr("data-progress-width") );
                $this.find(".ts-progress-value2").css("left", $this.attr("data-progress-width"));
            }
        });
    });
